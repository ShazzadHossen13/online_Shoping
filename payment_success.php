		...
		<div class='col-md-8'>
			<div class="panel panel-default">
  				...
  				<div class="panel-body">    
    				Hello <?php echo $_SESSION['uname']; ?>, your order was placed successful.<br>
    				<br>Your Transaction ID is <?php echo "ORD0011".rand(); ?>
    				<br>You can continue with your shopping.<br><br>
                    Item will be delivered the address provided.
                    <p></p>
